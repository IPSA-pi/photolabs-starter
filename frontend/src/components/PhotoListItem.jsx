...
const PhotoListItem = (props) => {
  ...
  <div className="photo-list__item">
    <PhotoFavButton onFavorite={()=> props.onFavorite(props.data)}/>
    <img className="photo-list__image" src={props.data.urls.full} alt="" onClick={() => props.onImageClick(props.data)}/>
